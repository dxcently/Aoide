...
`aoide.drachma.base16` (bypassing synthesis) — the `sonata` and `hero` songs
both do, keyed by hand from their wallpapers; see
...
[[songbook/Pantheon-Grammar|Pantheon Grammar §6]]). (`hero` is the alternate
