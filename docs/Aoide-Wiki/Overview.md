...
- [[livery (rename to lyra)]] — the design-token layer and its engine: the immutable seam between nix structure and runtime rendering, native in `crates/song/src/livery/` as `lyra livery emit|resolve|lint`
