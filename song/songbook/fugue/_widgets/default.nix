# song/songbook/fugue/_widgets/default.nix — the widget-record roll-up.
#
# The ONLY file in this shelf that names the song. Every sibling `<slot>.nix`
# is a plain function that never types "fugue" or its own slot name — this
...
# the three-arity builder from `lib/song.nix`. Mirrors
# `song/songbook/sonata/_widgets/default.nix` (`8c087ba`) verbatim but for the
# owner name.
#
