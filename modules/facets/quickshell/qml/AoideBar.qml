...
// geometry come from the tokens property (no hardcoded values).
//
...
Item {
    ...
    // ── Token + bridge dependencies (injected by shell.qml) ───────────────
    required property var tokens
    required property var bridge

    // ── Bar geometry ───────────────────────────────────────────────────────
    // Height driven by tokens when a geometry tier is added (v1). For now,
