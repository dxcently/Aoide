...
//! bodies live in
//! `screen::hypr`/`screen::capture`/`screen::point`/`screen::diff`/
//! `screen::text`; this module only wires schema metadata to them —
//! nothing here duplicates screen-domain logic (mirrors
//! `commands/graph.rs`'s own split of verbs from logic).
...
pub fn register(r: &mut Registry) {
    ...
    r.insert(cmd!(
        ...
        gated: false,
        implemented: true,
        handler: crate::screen::point_drag,
    ));
    r.insert(cmd!(
        ...
        gated: false,
        implemented: true,
        handler: crate::screen::point_hover,
    ));
    r.insert(cmd!(
    ...
    r.insert(cmd!(
        ...
        gated: false,
        implemented: true,
        handler: crate::screen::point_text,
    ));
